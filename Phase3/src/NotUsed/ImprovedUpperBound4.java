...
public class ImprovedUpperBound4 extends Thread {
	
	public void run()
	{
		int returnedValue = advancedBacktrack(e, n, upperBound, upperBoundValues, coloringOrder);
		obj.setUpperBound4(returnedValue);
	}
	
	public ImprovedUpperBound4(ColEdge[] e, int n, int upperBound, int[] upperBoundValues, int[] coloringOrder, UpperBound obj)
	{
		this.e = e;
		this.n = n;
	  ...
	  public static int advancedBacktrack(ColEdge[] e, int n, int upperBound, int[] upperBoundValues, int[] coloringOrder)
		{
			...
			while (possible && !timeUp)
			{
				...
				for (int i = 0; i < coloringOrderFinal.length; i++)
				{
