...
public class ImprovedUpperBound2 extends Thread {
	
	public void run()
	{
		int returnedValue = advancedBacktrack(e, n, upperBound, upperBoundValues, coloringOrder);
		obj.setUpperBound2(returnedValue);
	}
	
	public ImprovedUpperBound2(ColEdge[] e, int n, int upperBound, int[] upperBoundValues, int[] coloringOrder, UpperBound obj)
	{
		this.e = e;
		this.n = n;
